...
public class TurnTurnUIManager : MonoBehaviour
{
    ...
    {
        // TurnTurnScoreManager에서 현재 점수 가져와서 저장
        int curScore = FindObjectOfType<TurnTurnScoreManager>().GetCurScore();
        long unixTime = DateTimeOffset.Now.ToUnixTimeSeconds();
        TurnTurn_Records.SaveScoreToCSV(curScore, unixTime);
