...
public static class GateData
{
    ...
    static List<(float, float)> _horizontalPosition = new List<(float, float)> { (1.5f, 2.0f), (1.5f, 2.4f), (1.5f, 2.6f), (1.5f, 2.8f), (1.5f, 3.0f), (1.5f, 3.2f), (1.5f, 3.4f), (1.5f, 3.6f), (1.5f, 3.8f), (1.5f, 4.0f) };
